            ...
            <div class="md:hidden flex ">
                ...
                @if (isset($user))
                    <a href="{{ route('alerts', $user->id) }}"
                        class=" px-3 block text-center text-white hover:text-gray-300 focus:border-b-slate-100"><svg
            ...
            <div class="hidden md:flex items-center space-x-4">
                <a href="{{ route('redirect') }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                        ...
                        <path fill=" {{Route::currentRouteNamed('redirect') ? '#87cefa' : 'currentColor'}} "
                ...
                @if (Auth::check())
                    <a href="{{ route('profile', Auth::id()) }}"
                        class="text-white hover:text-gray-300 flex flex-col items-center justify-center group relative hover:cursor-pointer transition transform ease-in"><svg
                            ...
                            <path fill="{{Route::currentRouteNamed('profile') ? '#87cefa' : 'currentColor'}}"
                    ...
                    <a href="{{ url('/login.logout') }}"
                        class="text-white hover:text-gray-300 flex flex-col items-center justify-center group relative hover:cursor-pointer transition transform ease-in"><svg
                            xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                            class="transition transform group-hover:-translate-y-2 hover:scale-90">
                            <path fill="{{ Request::is('login.logout') ? '#87cefa' : 'currentColor' }}"
                    ...
                    @if (isset($user))
                        <a href="{{ route('alerts', $user->id) }}"
                            class="text-white hover:text-gray-300 flex flex-col items-center justify-center group relative hover:cursor-pointer transition transform ease-in"><svg
                                xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                                class="transition transform group-hover:-translate-y-2 hover:scale-90">
                                <path fill="{{Route::currentRouteNamed('alerts') ? '#87cefa' : 'currentColor'}}"
                                    d="M12 22c1.1 0 2-.9 2-2h-4a2 2 0 0 0 2 2m6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1z" />
                                <circle cx="20" cy="4" r="2"
                                    fill="{{ $hasNewAlerts ? '#6366F' : 'transparent' }}"
                                    class="{{ $hasNewAlerts ? 'animate-ping' : 'hidden' }}"></circle>
                ...
                @else
                    <a href="{{ url('/signup') }}"
                        class="text-white hover:text-gray-300 flex flex-col items-center justify-center group relative hover:cursor-pointer transition transform ease-in"><svg
                            xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                            class="transition transform group-hover:-translate-y-2 hover:scale-90">
                            <path fill="{{ Request::is('signup') ? '#87cefa' : 'currentColor' }}"
                    ...
                    <a href="{{ url('/login') }}"
                        class="text-white hover:text-gray-300 flex flex-col items-center justify-center group relative hover:cursor-pointer transition transform ease-in"><svg
                            xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                            class="transition transform group-hover:-translate-y-2 hover:scale-90">
                            <path fill="{{ Request::is('login') ? '#87cefa' : 'currentColor' }}"
